...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sell_nat-facilitator_api1.yahoo.com";
    private string APIPassword = "KR86M6V2RAX3NGT4";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AEJ55P5yteGXmQgSMkgsH-rkGDE6";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (TinyGeckoToyCompany.Logic.ShoppingCartActions myCartOrders = new TinyGeckoToyCompany.Logic.ShoppingCartActions())
        {
